...
const hobbies = [
  {
    ...
    title: "开源贡献",
    description:
      "积极参与开源社区，为多个流行库贡献代码，包括React组件库和工具包。",
  },
  {
    icon: <Book className="h-8 w-8" />,
    title: "阅读",
    description:
      "热爱阅读技术书籍和科幻小说，每年阅读约30本书，保持对新知识的探索。",
  },
  {
    icon: <Music className="h-8 w-8" />,
    title: "音乐",
    description:
      "业余吉他爱好者，喜欢在闲暇时间弹奏和创作音乐，偶尔参加小型演出。",
  },
  {
    icon: <Camera className="h-8 w-8" />,
    title: "摄影",
    description:
      "热爱风景和街头摄影，记录生活中的美好瞬间，探索不同的视角和构图。",
  },
  {
    icon: <Bike className="h-8 w-8" />,
    title: "骑行",
    description:
      "周末喜欢骑行探索城市和郊外，既锻炼身体又放松心情，享受户外活动。",
  },
  {
    icon: <Gamepad className="h-8 w-8" />,
    title: "电子游戏",
    description:
      "享受策略和角色扮演类游戏，偶尔参与游戏开发社区，尝试制作小型游戏。",
  },
  {
    icon: <Utensils className="h-8 w-8" />,
    title: "烹饪",
    description:
      "喜欢尝试不同菜系的烹饪，特别是亚洲和地中海料理，享受创造美食的过程。",
  },
  {
    icon: <Plane className="h-8 w-8" />,
    title: "旅行",
    description:
      "热爱探索不同文化和风景，已经去过15个国家，计划未来继续增加这个数字。",
  },
];
